    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 py-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center">
      ...
      >
        <div className="text-center mb-8" data-aos="fade-down">
          <h1 className="text-3xl font-bold text-gray-800 mb-2 font-serif">Welcome Back</h1>
          <p className="text-gray-600">Log in to continue planning your dream wedding.</p>
        </div>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0" data-aos="fade-up" data-aos-delay="100">
