...
const categories = Object.keys(initialCategoryLimits);
...
const BudgetTracker = () => {
  ...
  const handleLimitChange = (category, value) => {
    const updated = {
      ...categoryLimits,
      [category]: isNaN(parseFloat(value)) ? 0 : parseFloat(value)
    };
  ...
  return (
    <div className="budget-container">
      ...
      <section className="edit-total-budget">
      ...
      <section className="edit-limits">
        <h2>Edit Category Limits</h2>
