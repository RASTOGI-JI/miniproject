    ...
    <div className="service-container">
      ...
      <section className="service-hero" role="banner">
        ...
        >
          ...
          <p>
            From vision to victory, our comprehensive wedding services ensure your day is unforgettable.
            Let us handle the details while you cherish every moment.
          </p>
          <motion.button
      ...
      <section className="service-cta">
        ...
        >
          ...
          <motion.button
            ...
            onClick={() => navigate('/pricing')} // Optional CTA to Pricing too
          >
            Get Started Now
          </motion.button>
        </motion.div>
